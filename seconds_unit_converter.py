...
- Allow the user to do a multiple-choice select instead of making the user input the starting unit by manually typing it in. Maybe there is a module/builtin function I'm not aware of?
    - Or, alternatively, can I make the initial input a series of query params or just arguments passed?
